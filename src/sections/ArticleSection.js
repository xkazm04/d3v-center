...
import { PacmanIcon } from '../icons/landing';
    ...
    return (
            <>
                ...
                <Row>  
                         ...
                         <ArticleCard  date='6.6.2022' title='D3V Library: Tools' description='2nd project milestone and new features' pic={<DataflowIcon width='100px' color={theme.tool.dataflow}/>}  reference='/'/>
                    </Row>
                    <Row>  
                    <ArticleCard date='1.7.2022' title='NFT Gaming Dev Tools' description='Comparing available tooling for play-and-earn projects.' pic={<PacmanIcon width='100px' color={theme.tool.nft}/>} reference='https://medium.com/web3-magazine/nft-gaming-dev-tools-a4b7651f6a48'/>
